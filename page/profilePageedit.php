...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #D40013; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    <div class="body d-flex justify-content-between">
        <h4>Edit Profile</h4>
        <a class="border-0" href="../page/detaiProfilePage.php">
            <i style="color: red" class="fa fa-arrow-left fa-2x"></i>
        </a>
    </div>
    <hr>

    <form class="in-line" action="../process/profileProcessedit.php" method="post">
        ...
        <div class="text-right">
            <button class="btn btn-primary waves-effect" type="submit" name="edit"><i class="fa fa-plus"></i> Save</button>
        </div>
    </form>
</div>
</aside>
